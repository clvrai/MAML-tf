...
class MAML(object):
    def __init__(self, model_type, loss_type, dim_input, dim_output, alpha, beta, K, batch_size):
        '''
    ...
    def learn(self, batch_size, dataset, max_steps):
        ...
        for step in range(int(max_steps)):
            ...
            if step % LOG_FREQ == 0:
                log.infov("Meta train loss: {}, Meta val loss: {}".format(
